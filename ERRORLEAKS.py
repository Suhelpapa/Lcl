...
BOT_TOKEN = os.environ.get('8497027085:AAFiw4_WQLOZKG4TC2GSBThryIHBrbtCFTg')
API_ID = int(os.environ.get('34762717', 0))
API_HASH = os.environ.get('cefd5b28ccaacb1ef580502a077f1794')
